...
\begin{document}
    ...
    However in practice most optimizers (such as \textbf{Gurobi}) provide heuristic algorithms to compute the initial solution, and the results are usually better than the ones provided by random sampling.
    ...
    This algorithm provides better results than \textit{random sampling}, but it's not always better than leaving the heuristic initialization to the solver. 
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{lrrrrr}
            ...
            \hline
            \\[-1.5ex]
            Claus & 6.81 & 91.10 & 87.06 & 253.78 & 86.20 \\ 
            FCG & 7.18 & 16.90 & 12.28 & 46.00 & 13.33 \\ 
            MTZ & 7.62 & 22.62 & 14.42 & 64.69 & 19.75 \\ 
            \\[-1.6ex]
            \hline
        \end{tabular}
